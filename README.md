...
- Instala Mongodb y asegurate que este corriendo
- Instala nodemon global (`npm i -g nodemon`)
- Corre `npm run b` para desarrollo y `npm run b:prod` para produccion
- Checa los scripts en el `package.json` para saber que mas puedes correr
...
- [Pato Beltran](https://github.com/patobeltran)